...
function IconCSSI({ className, ...props }: React.ComponentProps<'img'>) {
  return (
    <Image
      ...
      width={16}
      height={16}
      className={cn('size-4 object-cover scale-150', className)}
      {...(props as any)}
    />
  )
}
...
function IconCheckCircleFill({ size = 16 }: { size?: number }) {
  return (
    <svg
      height={16}
      strokeLinejoin="round"
